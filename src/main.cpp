...
int64 nChainStartTime = 1388707200;
...
const string strMessageMagic = "300coin Signed Message:\n";
...
static const int64 nMinSubsidy = 0.00003 * COIN;

// miner's coin base reward based on nBits
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    int64 nSubsidy = 0.00003 * COIN;

    if(nHeight%300==0)
	{
        nSubsidy = 0.0003 * COIN;
	}

    // Subsidy is cut in half every 1000000 blocks, which will occur approximately every year
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // 300coin: 1 day
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in 300coin
    bool fStrictPayToScriptHash = true; // Always active in 300coin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "300coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
